...
CODE = '17f5fecb' #Fill in your code, which you get after authorization with your trakt account
...
def get_trakt_data(auth_token):
    ...
    req = urllib2.Request('https://api.trakt.tv/sync/history', headers=headers)
